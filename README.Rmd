...
The directory `dev/es` contains the Excel files with the translations. These
can be used as templates for translations to other languages different from
Spanish.
...
El _dataset_ `puntaje_pais` es una traducción del original `country_scores`:
...
`texto_calificacion_pais` es una traducción del original `country_rating_texts`:
